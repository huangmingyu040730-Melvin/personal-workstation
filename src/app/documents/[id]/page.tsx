      ...
      <PageHeader
        ...
        action={
          <div className="flex flex-wrap gap-2">
            <Link href={`/documents/${document.id}/download`} className="inline-flex items-center gap-2 rounded-2xl bg-navy-900 px-4 py-2.5 text-sm font-semibold text-white hover:bg-navy-800">
              <Download size={16} />
              下载文件
            </Link>
