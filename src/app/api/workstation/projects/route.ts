...
import { summarizeListRequest, summarizeProjectCreateRequest } from "@/lib/workstation/request-summary";
import {
...
export async function GET(request: NextRequest) {
  const context = createWorkstationRequestContext(request, "projects.list", "project");
...
export async function POST(request: Request) {
  const context = createWorkstationRequestContext(request, "projects.create", "project");
  ...
  try {
    ...
    const requestSummary = summarizeProjectCreateRequest(bodyResult.body);
