  ...
  return (
    <AppShell>
      <PageHeader
        ...
        action={
          <Link href="/projects/new" className="inline-flex items-center gap-2 rounded-2xl bg-navy-900 px-4 py-2.5 text-sm font-semibold text-white hover:bg-navy-800">
            <Plus size={16} />
            新建项目
          </Link>
        }
      ...
      {projects.length === 0 ? (
        <Card className="text-center">
          ...
          <Link href="/projects/new" className="mt-5 inline-flex rounded-2xl bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white">新建项目</Link>
        </Card>
      ) : (
