  ...
  return (
    <AppShell>
      <PageHeader
        ...
        action={<Link href="/skills/new" className="inline-flex items-center gap-2 rounded-2xl bg-navy-900 px-4 py-2.5 text-sm font-semibold text-white hover:bg-navy-800"><Plus size={16} />新建 Skill</Link>}
      />
      ...
      {skills.length === 0 ? (
        <Card className="text-center">
          ...
          <Link href="/skills/new" className="mt-4 inline-flex rounded-2xl bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white">新建 Skill</Link>
        </Card>
      ) : (
