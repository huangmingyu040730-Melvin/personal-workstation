...
export function buildPublicationAiDraftPrompt(draft: PublicationAiDraft) {
  const safeDraft = {
    title: truncateText(draft.title, 160),
...
export function buildKnowledgeAiDraftPrompt(draft: KnowledgeAiDraft) {
  const safeDraft = {
...
export function buildSkillAiDraftPrompt(draft: SkillAiDraft) {
  const safeDraft = {
