...
export const resumeJdReviewStatusOptions: Array<{ value: ResumeJdReviewStatus; label: string; tone: string }> = [
  ...
  { value: "reviewed", label: "已复盘", tone: "bg-blue-50 text-blue-700 ring-blue-100" },
  { value: "ready", label: "可投递", tone: "bg-emerald-50 text-emerald-700 ring-emerald-100" },
  ...
  { value: "rejected", label: "未通过", tone: "bg-rose-50 text-rose-700 ring-rose-100" },
  { value: "offer", label: "Offer", tone: "bg-green-50 text-green-700 ring-green-100" },
  { value: "archived", label: "归档", tone: "bg-slate-100 text-slate-500 ring-slate-200" }
];
