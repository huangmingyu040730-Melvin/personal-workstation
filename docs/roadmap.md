...
已完成代码实现。后台 Documents、搜索、研究资产详情页和显式关系管理阶段性完成后，下一阶段转向公开展示质量，把首页和公开导航打磨为更清晰的“公开研究工作站”入口：

- 首页首屏明确表达“公开研究工作站”定位。
- 首页展示研究方向、公开 Project / Publication / Knowledge / Skill 预览和访问申请入口。
- 公开导航包含首页、研究项目、学术成果、知识库、Skill 库和访问申请。
- 普通访客公开导航不显示后台管理、文件中心或全局关系图谱入口。
...
- public 页面只展示明确设为 `public` 的内容；公开首页和公开导航承担“公开研究工作站”说明、研究方向、公开内容预览和访问申请入口。
...
- Documents 多资产关联、显式研究资产关系和后台搜索仍是管理员后台能力，不在公开页面展示或作为公开导航入口。
