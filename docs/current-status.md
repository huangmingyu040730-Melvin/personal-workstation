...
- Phase 2R-F-2 后，公开首页精选内容区统一为 featured 优先、最近更新补足的 public 内容入口，覆盖精选研究项目、精选学术成果、最新知识笔记和公开 Skill / 工作流，并新增轻量“关于这个工作站”说明。
