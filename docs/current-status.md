...
- 公开首页 `/`。
- Phase 2R-A-1 后，首页首屏明确表达“公开研究工作站”定位，并聚合研究方向、公开 Project / Publication / Knowledge / Skill 预览和访问申请 CTA。
- 公开导航包含首页、研究项目、学术成果、知识库、Skill 库和访问申请，不显示后台管理、文件中心或全局关系图谱入口。
- About 页面 `/about`。
...
- 公开展示：Phase 2R-A-1 起把公开首页作为“公开研究工作站”入口维护，清晰展示研究方向、公开 Projects、Publications、Knowledge、Skills 和访问申请；公开导航不显示后台管理、文件中心或全局关系图谱入口，公开页面继续只读展示 public 内容。
