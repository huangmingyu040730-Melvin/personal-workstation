...
v1.1 polish 不新增 migration。#125、#126、#127、#128 和本轮 final QA 只围绕边界、文案、表单预填、搜索 / 列表 / 移动端展示、维护清单和 release notes 打磨；不修改数据库 schema、RLS、Storage policy、bucket visibility、Documents 文件读取或 public 文件下载 route。
