...
- Profile 个人公开信息编辑基础。
- Calendar 站内日程 CRUD。
- Market Briefs 市场简报后台手工 CRUD、Markdown 主内容、站内预览、多格式下载、mock / external runner 生成模式、Python AkShare runner 与生成任务记录。
- Resume 履历素材库基础 CRUD。
- Resume 简历版本组合与后台预览。
