...
- Phase 2R-A-1 公开首页与公开导航 polish 不需要新增 migration；公开页面继续使用既有 public 查询和 RLS 边界，不公开 Documents、附件下载、Storage 路径、signed URL 或后台关系管理。
