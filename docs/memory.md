...
- Phase 2R-A-1：公开首页与公开导航 polish，首页首屏明确表达“公开研究工作站”，展示研究方向、公开 Project / Publication / Knowledge / Skill 预览和访问申请入口。
...
- Phase 2R-A 后，公开导航面向普通访客，只保留首页、研究项目、学术成果、知识库、Skill 库和访问申请，不展示后台管理、文件中心或全局关系图谱入口。
...
- Phase 2R-A-1 采用 public presentation polish 决策：后台核心能力阶段性完成后转向公开展示质量；公开首页聚合研究方向、公开内容预览和访问申请，公开页面继续只展示 public 内容，不公开 Documents、附件、Storage 路径、signed URL、后台文件关联或显式关系管理。
