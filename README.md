...
- Phase 2R-F-2 公开首页精选内容 polish：首页精选区优先展示 featured public 内容，不足时用最近更新的 public 记录补足，并补充关于工作站的轻量入口；不新增数据库或恢复外部授权链路
