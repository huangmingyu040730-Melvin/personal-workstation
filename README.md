...
当前项目状态详见 `docs/current-status.md`，公开内容运营指南详见 `docs/public-content-operations.md`，访问申请后台处理流程详见 `docs/access-request-workflow.md`，Access Grants 授权管理流程详见 `docs/access-grants-workflow.md`，后续阶段规划详见 `docs/roadmap.md`，已知问题详见 `docs/known-issues.md`。
...
- Access Grants 已具备后台创建、列表、详情和撤销管理；列表支持有效 / 过期 / 撤销与内容类型筛选，创建仍必须手动选择具体 restricted 内容。restricted 访问链路仍需 Phase 2I 稳定 Viewer 登录。
