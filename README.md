...
- Phase 2R-A 起公开首页与公开导航转向“公开研究工作站”展示 polish，首页聚合研究方向、公开 Project / Publication / Knowledge / Skill 预览和访问申请入口
...
- Phase 2R-A-1 起公开首页和公开导航强调“公开研究工作站”定位，首页展示研究方向、公开 Project / Publication / Knowledge / Skill 预览和访问申请入口；公开页面仍只展示 public 内容，不公开 Documents、附件下载、Storage 路径、signed URL 或后台关系管理。
