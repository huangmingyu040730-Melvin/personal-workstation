...
- Phase 2R-A 起公开首页与公开导航转向“黄铭语研究工作站”展示 polish；首页 H1 使用“个人研究工作站”，首屏恢复左侧个人定位 / 标签 / CTA 与右侧公开统计卡片结构，Knowledge / Skill 首页预览使用更紧凑卡片展示更多 public 条目，并在公开导航保留轻量“管理员登录”入口；Phase 2R-A-2 进一步用轻量 CSS 背景装饰和系统字体栈增强金融、量化、研究和学术视觉识别；Phase 2R-A-3 将公开 Projects / Publications / Knowledge / Skills 列表页 polish 为正式研究内容索引
